...
const Portfolio = () => {
  ...
  const projects = useMemo<ProjectType[]>(() => [
    {
      ...
      description: "A gorgeous premium 4BHK luxury residential villa built with reinforced concrete framing and custom stone masonry facades.",
      image: "/living area 2.jpg",
      tags: ["RCC Frame", "Stone Facade", "Luxury Villa"],
      location: "Whitefield, Hosur"
    },
    {
      id: 2,
      title: "Corporate HQ Complex",
      category: "commercial",
      description: "An elegant multistory commercial office tower featuring a glass curtain wall, post-tensioned slabs, and premium open interiors.",
      image: "/master bedroom 2.jpeg",
      tags: ["Glass Facade", "Commercial Tower", "Post-Tensioned Slabs"],
      location: "ORR, Hosur"
    },
    {
      id: 3,
      ...
      category: "residential",
      description: "Custom-built 3-story residential bungalow with natural slate roofing, spacious balconies, and highly durable finishing.",
      image: "/master bedroom 3.jpg",
      tags: ["Bungalow", "Independent House", "Slate Roofing"],
      location: "Indiranagar, Hosur"
    },
    {
      id: 4,
      title: "High-Rise Apartment Block",
      category: "residential",
      description: "A multistory apartment tower housing modern 3BHK flats with seismic-resistant RCC designs and smart rainwater harvesting.",
      image: "/m bedroom 1.jpg",
      tags: ["Seismic-Resistant", "Apartment Tower", "Rainwater Harvesting"],
      location: "Sarjapur, Hosur"
    },
    {
      id: 5,
      title: "Contemporary Retail Showroom",
      category: "commercial",
      description: "A spacious and high-ceilinged retail showroom with heavy-duty structural load capability and premium front glazing.",
      image: "/appartment 1.jpg",
      tags: ["Retail Hub", "Showroom", "Front Glazing"],
      location: "Jayanagar, Hosur"
    },
    {
      id: 6,
      title: "Modern Villa Restoration",
      category: "renovations",
      description: "A complete civil renovation and remodeling project adding a contemporary pool house and upgrading the foundation layout.",
      image: "/bathroom 1.jpg",
      tags: ["Foundation Upgrade", "Renovation", "Extension"],
      location: "Koramangala, Hosur"
    },
    {
      id: 7,
      title: "Industrial Logistics Warehouse",
      category: "commercial",
      description: "A heavy-duty pre-engineered steel structure custom built for warehousing, logistics, and high clearance requirements.",
      image: "/bathroom 2.jpg",
      tags: ["PEB Structure", "Warehouse", "Logistics Hub"],
      location: "Nelamangala, Hosur"
    },
    {
      id: 8,
      title: "Eco-Friendly Residence",
      category: "residential",
      description: "A green building project using compressed stabilized earth blocks (CSEB) and organic clay-tile roofing for maximum thermal insulation.",
      image: "/bathroom 3.jpg",
      tags: ["Green Building", "Earth Blocks", "Thermal Comfort"],
      location: "HSR Layout, Hosur"
    }
  ], []);
  ...
  const categories = [
    ...
    { id: "renovations", name: "Renovations & Upgrades" }
  ];
    ...
    <div className="bg-white text-gray-900 font-sans">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 to-white">
        ...
        <div className="relative max-w-6xl mx-auto px-8 py-20 text-center z-10">
          ...
          <motion.h1 
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 mt-6 mb-8 leading-tight"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p 
            className="text-base sm:text-lg md:text-xl text-gray-700 max-w-2xl mx-auto font-light leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.6 }}
          >
            Explore our collection of exceptional residential, commercial, and structural construction projects
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-24 px-8 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p 
            className="text-base sm:text-lg text-gray-700 mb-8 font-light"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            ...
            >
              <div className="relative">
                ...
                <div className="p-6">
                  ...
                  <div className="mb-8">
                    <h3 className="text-lg font-medium text-gray-900 mb-3">Structural Features</h3>
