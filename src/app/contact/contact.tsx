...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    { 
      icon: "📍", 
      title: "Location", 
      content: "Hosur, Krishnagiri - 635109",
      link: "https://www.google.com/maps/search/?api=1&query=Hosur+Krishnagiri+Tamil+Nadu+635109"
    }
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-gray-700 font-light max-w-2xl mx-auto">
                Construct your dream project with our expert civil engineering and building services. We&apos;re here to bring your structural vision to life.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              <div>
                <h3 className="text-2xl font-light text-gray-900 mb-4">Contact Information</h3>
      ...
      <section className="bg-gray-50 py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-light text-gray-900 mb-3">Visit Our Office</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">We&apos;d love to welcome you to our corporate office. Schedule a visit to see our structural portfolio and discuss your project in person.</p>
          </div>
          
          <div className="aspect-video bg-gradient-to-br from-gray-200 to-gray-300 rounded-2xl overflow-hidden shadow-xl relative">
            {/* Embedded Google Map for Hosur, Krishnagiri */}
            <iframe
              title="Velan Constructions - Hosur, Krishnagiri"
              src="https://www.google.com/maps?q=Hosur+Krishnagiri+Tamil+Nadu+635109&output=embed"
          ...
          <div className="mt-8 text-center">
            <motion.a
              href="https://www.google.com/maps/search/?api=1&query=Hosur+Krishnagiri+Tamil+Nadu+635109"
              target="_blank"
