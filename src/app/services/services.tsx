  ...
  const services: ServiceType[] = [
    {
      ...
      description: "Build your dream home with our high-end residential engineering, custom villas, and residential layout structures.",
      icon: "🏠",
      features: ["Custom Villa Building", "Duplex Homes", "Apartment Complexes", "Independent House Construction"],
      gradient: "from-blue-400 to-purple-500"
    },
    {
      id: 2,
      title: "Commercial Contracting",
      description: "Construct functional, premium-grade corporate offices, business structures, retail hubs, and showrooms.",
      icon: "🏢",
      features: ["Office Building Works", "Retail Showrooms", "Warehouses & Factories", "Pre-engineered Buildings"],
      gradient: "from-green-400 to-cyan-500"
    },
    {
      id: 3,
      title: "Civil Renovations & Extensions",
      description: "Upgrade and expand your existing buildings with absolute structural stability and quality enhancements.",
      icon: "🔨",
      features: ["Structural Retrofitting", "Building Extensions", "Home & Office Remodeling", "Demolition & Re-carpeting"],
      gradient: "from-orange-400 to-red-500"
    },
    {
      id: 4,
      title: "Sustainable Civil Works",
      description: "Eco-friendly, energy-efficient building structures using modern sustainable civil engineering standards.",
      icon: "🌿",
      features: ["Rainwater Harvesting Sets", "Solar Grid Integration", "Thermal Comfort Plastering", "Fly Ash Brick Masonry"],
      gradient: "from-emerald-400 to-teal-500"
    },
    {
      id: 5,
      title: "Architectural Planning & Liaison",
      description: "In-house floor plans, 3D structure elevations, structural blueprint checks, and local sanctioning liaison.",
      icon: "📐",
      features: ["2D/3D Floor Blueprinting", "Zoning & Approval Liaison", "RCC Structural Design", "Landscape Planning"],
      gradient: "from-amber-400 to-yellow-500"
    },
    {
      id: 6,
      title: "Turnkey Project Management",
      description: "End-to-end site coordination, material supervision, and labor contracting from excavation to key handover.",
      icon: "📋",
      features: ["Bill of Quantities (BOQ)", "Strict Site Safety Checks", "Subcontractor Oversight", "Material Quality Control"],
  ...
  const processSteps = [
    {
      ...
      description: "We perform feasibility checks on your site layout, map requirements, and deliver a detailed initial cost estimate.",
      icon: "💬"
    },
    {
      step: "02",
      title: "Blueprinting & Structural Design",
      description: "Our in-house architects design custom floor layouts, 3D structural designs, and draft the foundation blueprints.",
      icon: "📐"
    },
    {
      step: "03",
      title: "Material Sourcing & Procurement",
      description: "We coordinate the procurement of premium-grade steel, cement, aggregates, and fittings backed by top brands.",
      icon: "🧱"
    },
    {
      step: "04",
      title: "Core Construction Work",
      description: "Our skilled civil engineers execute excavation, RCC framing, roofing, blockwork, plumbing, and wiring.",
      icon: "🏗️"
    },
    {
      step: "05",
      title: "Finishing & Handover",
      description: "Meticulous tile laying, painting, plaster checks, and system trials are done before handing over the keys.",
      icon: "✨"
    }
  ];
    ...
    <div className="bg-white text-gray-900 font-sans overflow-hidden" ref={containerRef}>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center z-10">
          ...
          <motion.h1 
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 mt-6 mb-8 leading-tight px-4"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p 
            className="text-base sm:text-lg md:text-xl text-gray-700 max-w-3xl mx-auto font-light leading-relaxed px-4"
        ...
        <div className="max-w-6xl mx-auto">
          <AnimatedSection delay={0.1}>
            <div className="text-center mb-12 sm:mb-16 lg:mb-20">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-light text-gray-900 mt-4 mb-4 sm:mb-6">
                How We Work
              </h2>
      ...
      <section className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <AnimatedSection delay={0.1}>
            ...
            <motion.p 
              className="text-base sm:text-lg text-gray-300 mb-6 sm:mb-8 font-light max-w-2xl mx-auto px-4"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              Let&apos;s discuss your project and construct a structure that exceeds your quality expectations.
            </motion.p>
