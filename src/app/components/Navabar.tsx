...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Brochures', href: '/brochure', icon: 'document' },
  ];
  ...
  return (
    <>
          ...
          <div className="flex justify-between items-center py-2 md:py-0">
            ...
            <div className="hidden md:flex items-center">
              ...
              >
                <Link 
                  href="/contact"
                  className={`px-4 py-2 md:px-6 rounded-full font-medium hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 ${
                    isScrolled 
            ...
            >
              ...
              <span 
                className={`absolute w-8 h-1 transition-all duration-300 rounded ${
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div 
            className="fixed inset-0 bg-black/70 z-[60] md:hidden backdrop-blur-sm"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center justify-between p-6 border-b border-orange-100">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <span className="text-orange-900 font-bold text-xl">Velan</span>
                    <p className="text-xs text-orange-600">Constructions</p>
                  </div>
                </div>
                <motion.button 
