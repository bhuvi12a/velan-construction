    ...
    >
      ...
      >
        ...
        <div className="text-center mb-5">
          ...
          >
            Premium civil construction services
          </motion.p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          >
            ...
            >
              ...
              <option value="renovation">Civil Renovations & Extensions</option>
              <option value="sustainable">Sustainable Civil Works</option>
              <option value="architectural">Architectural Blueprinting</option>
