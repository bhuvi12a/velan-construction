...
const testimonials: Testimonial[] = [
  {
    ...
    name: "Prashanth.G",
    role: "Homeowner",
    content: "Working with Velan Constructions transformed our site into a beautiful dream home. Their structural safety, premium grade materials, and transparent billing were remarkable. The team delivered beyond our expectations.",
    rating: 5,
  ...
  },
  {
    ...
    content: "The team's structural expertise and execution speed exceeded our expectations. They constructed an amazing multistory commercial structure that perfectly balances safety and high structural load requirements.",
    rating: 5,
    project: "Luxury Commercial Complex"
  },
  {
    id: 3,
    name: "Satish Kumar",
    role: "Villa Owner",
    content: "They managed to complete our luxury villa with outstanding precision and timing. The RCC foundation works were flawless and the process was highly cooperative from day one.",
    rating: 5,
    project: "Premium Custom Villa"
  },
  {
    id: 4,
    name: "Prajwal",
    role: "Showroom Owner",
    content: "Our retail commercial building has been completely transformed. The civil layout looks robust, clean, and modern, ensuring perfect space utilization and structural integrity.",
    rating: 5,
    project: "Retail Commercial Showroom"
  },
  {
    id: 5,
    name: "Priya Patel",
    role: "Office Developer",
    content: "The corporate building construction has boosted our company's corporate workspace capability and safety. The team integrated high-end seismic resistance and modern concrete finishes.",
    rating: 5,
  ...
  },
  {
    ...
    content: "From soil excavation to slab roofing and final plastering, their professionalism and attention to IS code details were outstanding. Our apartment building is robust, durable, and highly compliant.",
    rating: 5,
    project: "Multistory Residential Apartments"
  }
];
  ...
  const TestimonialCard = ({ testimonial }: { testimonial: Testimonial }) => {
    ...
    return (
      ...
      >
        ...
        {/* Content */}
        <motion.p 
          className="text-gray-600 mb-4 leading-relaxed text-sm sm:text-base font-light"
          initial={{ opacity: 0 }}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              >
                Discover why clients love working with us to build robust structures that ensure safety and stand the test of time.
              </motion.p>
            </motion.div>
          </div>
        </div>
